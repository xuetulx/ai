...
function cmdCheck(args) {
  ...
  if (!st.exists) {
    ...
    if (st.managed) console.log('  ✓ AGENTS.md 含管理标记，规则区由插件维护');
    else {
      console.log('  [WARN] AGENTS.md 无管理标记，首次 sync 将备份并接管');
      bad++;
    }
