window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		const zh = {
			...
			subtitle: "发现社区为 DeepSeek Harness 打造的插件",
			...
			envFix: "自动配置",
			envFixing: "正在配置…",
			envFixFail: "自动配置失败，请点击\"导出日志\"，把文件附到 issue 里反馈",
			loading: "正在加载插件目录…",
			backTop: "回到顶部",
			confirm: "确认",
			cmdDetails: "安装命令",
